...
| `legal/` | Before work starts | Scope boundaries, document checklist, authorization letter |
| `kickoff/` | Week one | Agenda, stakeholder map, RACI, communication norms |
| `first-90/` | Weeks one to thirteen | 30/60/90 plan, week one checklist |
| `evidence/` | Rolling | The document request list |
| `offboarding/` | The end | Handover, data destruction, credential return |
...
- [Security-Program-Starter](https://github.com/HarrisonWard/Security-Program-Starter) for the policies you will hand them
- [vCISO-Playbook](https://github.com/HarrisonWard/vCISO-Playbook) for how to run the engagement once it starts
- [The-Board-One-Pager](https://github.com/HarrisonWard/The-Board-One-Pager) for reporting up
- [TPRM-RightSized](https://github.com/HarrisonWard/TPRM-RightSized) for the vendor work that always follows

## License

CC BY 4.0. Use it, change it, sell services with it. Credit is nice, not required.

## A note on the secret sauce
